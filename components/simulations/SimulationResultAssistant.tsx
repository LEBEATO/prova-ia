...
export default function SimulationResultAssistant({
  ...
  return (
    <>
      {active && (
        <div className="fixed bottom-44 right-6 z-40 max-w-[min(80vw,320px)] rounded-2xl border border-violet-400/20 bg-slate-950/95 px-3 py-3 text-xs text-slate-300 shadow-2xl backdrop-blur sm:bottom-24 sm:right-6">
